...
#TODO: AI
#TODO: ckeck for vaild grammar, if something wrong, is will wrong deep in inside code
# Check for only 1 program run, if not: kill the older
# Check for kill key
# Use smallest fps possible
#TODO: give each object a id base on index in Object[]
